...
static std::array<const char*, 16> s_display_aspect_ratio_names = {
  {TRANSLATABLE("DisplayAspectRatio", "Auto (Game Native)"), "Match Display", "Custom", "4:3", "16:9", "16:10", "19:9",
   "20:9", "21:9", "32:9", "8:7", "5:4", "3:2", "2:1 (VRAM 1:1)", "1:1", "PAR 1:1"}};
...
float Settings::GetDisplayAspectRatioValue() const
{
  ...
  {
    case DisplayAspectRatio::MatchDisplay:
    {
